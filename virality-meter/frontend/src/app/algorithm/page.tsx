...
export default function AlgorithmPage() {
    return (
        <main className="min-h-screen bg-term-bg scanlines p-4 md:p-8">
            <div className="max-w-4xl mx-auto">
                <div className="mb-6 flex justify-between items-center">
                    <Link
                        href="/"
                        className="text-xs font-mono text-term-cyan hover:text-term-green transition-colors flex items-center gap-2"
                    >
                ...
                >
                    ...
                    <div className="p-6 space-y-6 text-sm font-mono leading-relaxed">
                        {/* Header */}
                        <div className="border-b border-term-border pb-4">
                            <h1 className="text-xl text-term-green font-bold mb-3">
                        ...
                        <div className="space-y-4">
                            <h3 className="text-term-amber font-bold text-lg">
                                <span className="text-term-green">§1.</span> Three-Stage Pipeline
                            </h3>
                            <div className="pl-4 space-y-4 text-gray-300">
                                <div>
                                    <span className="text-term-cyan font-bold block mb-1">Stage 1: Candidate Retrieval</span>
                                    <p className="text-gray-400">
                                ...
                                <div>
                                    <span className="text-term-cyan font-bold block mb-1">Stage 2: Ranking (Phoenix Scorer)</span>
                                    <p className="text-gray-400">
                                ...
                                <div>
                                    <span className="text-term-cyan font-bold block mb-1">Stage 3: Filtering & Mixing</span>
                                    <p className="text-gray-400">
                        ...
                        {/* Engagement Signals */}
                        <div className="space-y-4 border-t border-term-border pt-6">
                            <h3 className="text-term-amber font-bold text-lg">
                            ...
                            <div className="grid md:grid-cols-2 gap-4">
                                <div className="bg-term-bg-light border border-term-green/30 p-4 rounded">
                                    <div className="text-term-green font-bold mb-2">HIGH VALUE SIGNALS</div>
                                ...
                                <div className="space-y-4">
                                    <div className="bg-term-bg-light border border-term-amber/30 p-4 rounded">
                                        <div className="text-term-amber font-bold mb-2">MEDIUM VALUE SIGNALS</div>
                                        <ul className="space-y-2 text-gray-300 text-xs">
                                    ...
                                    <div className="bg-term-bg-light border border-term-red/30 p-4 rounded">
                                        <div className="text-term-red font-bold mb-2">NEGATIVE SIGNALS (PENALTIES)</div>
                                        <ul className="space-y-2 text-gray-300 text-xs">
                        ...
                        <div className="space-y-4 border-t border-term-border pt-6">
                            ...
                            <div className="space-y-2 text-gray-300">
                                ...
                                <div className="bg-term-bg-light border border-term-cyan/30 p-4 rounded space-y-2 text-xs">
                        ...
                        <div className="space-y-4 border-t border-term-border pt-6">
                            ...
                            <div className="grid md:grid-cols-2 gap-4 text-xs">
                                <div className="bg-term-bg-light border border-term-green/30 p-4 rounded">
                                    <div className="text-term-green font-bold mb-2">CONTENT STRUCTURE</div>
                                    <div className="space-y-2 text-gray-300">
                                ...
                                <div className="bg-term-bg-light border border-term-amber/30 p-4 rounded">
                                    <div className="text-term-amber font-bold mb-2">ENGAGEMENT TRIGGERS</div>
                                    <div className="space-y-2 text-gray-300">
                        ...
                        <div className="space-y-4 border-t border-term-border pt-6">
                            ...
                            <div className="space-y-3 text-xs">
                                <div className="flex items-center gap-2">
                                    <span className="text-term-green font-bold w-24">OPTIMAL:</span>
                                    <span className="text-gray-300">1-5 tweets per day</span>
                                </div>
                                <div className="flex items-center gap-2">
                                    <span className="text-term-amber font-bold w-24">ACCEPTABLE:</span>
                                    <span className="text-gray-300">5-10 tweets per day</span>
                                </div>
                                <div className="flex items-center gap-2">
                                    <span className="text-term-red font-bold w-24">SPAM RISK:</span>
                        ...
                        {/* Footer Source */}
                        <div className="border-t border-term-border pt-6 text-xs">
                            <p className="text-gray-400">
